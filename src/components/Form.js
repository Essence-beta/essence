...
function Form() {
    ...
    const [details, setDetails] = useState({name:"", telegram: "", twitter: "", address: ""});
    const submitDetails = (e) => {
        e.preventDefault();
        setDetails({name: "", telegram: "", twitter: "", address: ""});
        details.name || details.telegram || details.twitter || details.address ? setSubmitModal(true) : setSubmitModal(false); 
    }
